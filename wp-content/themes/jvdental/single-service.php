...
<?php if (get_field('otobrazhenie_kategorij') == true) { ?>
    <section>
        <div class="container">
            <div class="row">
              <?php
              // Shortcode to output service on ALL service page
              function kategorii($atts)
              {
                $kategorii = get_field('kategorii');
                if (isset($kategorii)) {
                  $html = '<div class="col-md-12">
                  <div class="service-category">';
                foreach ($kategorii as $item) {
                    $html .= '
     <a href="' . get_the_permalink($item->ID) . '">   ' . get_field("nazvanie_kategorii", $item->ID) . '</a>
                                         ';
                  }
                  $html .= '</div></div>';
              ...
              add_shortcode('kategorii', 'kategorii');
              //END

              ?>
              <?php echo do_shortcode('[kategorii]'); ?>
            </div>
        </div>
    </section>
    <?php } else { ?>
                ...
                <div class="col-md-12">
                    <div class="about-l-title">
                        <div class="about-l-title-img"
                             style="background-image: url('<?= get_field("izobrazhenie_uslugi") ?>')">
                        ...
                        <div class="about-l-title-info">
                            <h1 class="about-l-title-info__heading">
                              <?= get_field("nazvanie_uslugi") ?>
                            </h1>
                            <div class="about-l-title-info__intro">
                              <?= get_field("opisanie_uslugi") ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php if (get_field('otobrazhenie_bloka_s_etapami') == true) { ?>
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    padding-left: 20px;
    margin-right: auto;
    margin-left: auto;"><?= get_field("tekst_posle_tabov_s_etapami") ?></div>
                </div>
            </div>
        </div>
    </section>
